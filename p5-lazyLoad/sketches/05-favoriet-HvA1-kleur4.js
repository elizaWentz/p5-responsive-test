...
function setup() {
  ...
  // Vibrant risograph-like inks
  palette = [
    color("#9f4f2d"), // hot magenta
    color("#efc82b"), // electric blue
    color("#c5eef7"), // acid yellow
    color("#efc7a3"), // vivid green
    color("#ffa9a3")  // punchy orange
  ];
}
  const cols = {
    rust: "#9f4f2d",
...
function draw() {
  background("#FFFBE8"); // pale paper color
