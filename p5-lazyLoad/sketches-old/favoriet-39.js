...
function addPreviewRisoGrain(intensity) {
  noStroke();

  for (let i = 0; i < 9000; i++) {
    const grain = (random() - 0.5) * (intensity * 255);
    fill(128 + grain, random(10, 24));
